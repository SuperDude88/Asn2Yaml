...
Following the main header, there is a 0x20 byte header for each of the 18 sections. They always range from 0-17, although some are not used. In that case, their name is ` (no named)` and 0 entries are listed:
